...
int main()
{
    ...
    // if (marks>=40)
    // {
    //     cout<<"Congraulation, You have passed."<<endl;
    // }
    // else
    // {
    ...
    // if (a*a==b)
    // {
    //     cout<<"The second number is the square of first number."<<endl;
    // }
    // else
    // {
    //     cout<<"The second number is not the square of first number."<<endl;
    // }
